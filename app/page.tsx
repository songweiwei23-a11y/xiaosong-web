  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="fixed top-0 w-full border-b border-border bg-background/80 backdrop-blur-md z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            <a href="#features" className="text-muted-foreground hover:text-blue-600 transition-colors">核心功能</a>
            <a href="#pricing" className="text-muted-foreground hover:text-blue-600 transition-colors">会员定价</a>
            <a href="#advantages" className="text-muted-foreground hover:text-blue-600 transition-colors">平台优势</a>
            <ThemeToggle />
            <LandingNavCTA />
          </nav>
        </div>
      ...
      <main className="pt-16">
        {/* Hero Section */}
        <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-blue-950/40 dark:via-purple-950/40 dark:to-pink-950/30 py-20 md:py-32">
          <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
          <div className="container mx-auto px-4 relative">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/80 dark:bg-white/10 backdrop-blur-sm border border-blue-200 dark:border-blue-800 px-4 py-2 text-sm font-medium text-blue-700 dark:text-blue-300 shadow-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                ...
                <a
                  href="#features"
                  className="inline-flex items-center justify-center gap-2 bg-card text-foreground border-2 border-border px-8 py-4 rounded-xl text-lg font-semibold hover:border-blue-600 hover:text-blue-600 transition-all"
                >
                  了解更多
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <div className="text-sm text-muted-foreground mt-1">脚本生成量</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-purple-600">20+</div>
                <div className="text-sm text-muted-foreground mt-1">行业覆盖</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-pink-600">35/35分</div>
                <div className="text-sm text-muted-foreground mt-1">专业评分</div>
              </div>
              <div>
                <div className="text-4xl font-bold text-orange-600">98%</div>
                <div className="text-sm text-muted-foreground mt-1">用户好评</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {[
                ...
                <div
                  key={i}
                  className="group relative bg-card rounded-2xl p-6 border-2 border-border hover:border-blue-300 hover:shadow-xl transition-all duration-300"
                >
        ...
        <section id="advantages" className="py-20 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/40 dark:to-purple-950/40 rounded-2xl p-8 border border-blue-200 dark:border-blue-900/50">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/40 dark:to-pink-950/40 rounded-2xl p-8 border border-purple-200 dark:border-purple-900/50">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-orange-50 dark:from-pink-950/40 dark:to-orange-950/40 rounded-2xl p-8 border border-pink-200 dark:border-pink-900/50">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-950/40 dark:to-yellow-950/30 rounded-2xl p-8 border border-orange-200 dark:border-orange-900/50">
        ...
        <section id="pricing" className="py-20 bg-gradient-to-b from-muted/30 to-background">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {/* Free Plan */}
              <div className="bg-card rounded-2xl p-8 border-2 border-border hover:shadow-lg transition-all">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold mb-2">免费版</h3>
                  <div className="text-4xl font-bold mb-2">¥0</div>
                  <div className="text-muted-foreground">永久免费</div>
                </div>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span className="text-sm text-muted-foreground/60">广告类脚本</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <X className="w-5 h-5 text-gray-300 dark:text-gray-600 flex-shrink-0 mt-0.5" />
                    <span className="text-sm text-muted-foreground/60">成交理由分析</span>
                  </li>
                </ul>
                <Link
                  href="/dashboard"
                  className="block text-center bg-muted text-foreground py-3 rounded-xl font-semibold hover:bg-muted/70 transition-colors"
                >
                  开始使用
                </Link>
              </div>
              ...
              <div className="bg-card rounded-2xl p-8 border-2 border-border hover:shadow-lg transition-all">
                <div className="text-center mb-6">
                  ...
                  <div className="text-muted-foreground">每月</div>
                </div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" />
