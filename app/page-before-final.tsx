...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {/* 保留原有的其他section... */}
      {/* 由于篇幅限制，保留原页面的功能列表、价格对比等其他section */}
      
      <div className="text-center py-20 bg-white dark:bg-slate-900">
        <p className="text-slate-500 mb-4">完整功能详情请继续向下滚动查看...</p>
        <Link href="/dashboard" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold hover:scale-105 transition-transform">
